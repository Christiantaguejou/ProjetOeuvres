...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/listerOeuvre.css">
    <link rel="stylesheet" href="/resources/css/liste.css">
    <script type="application/javascript" src="/resources/js/listerOeuvre.js"></script>
</head>
<body>
                    ...
                    <table id="tableFilter" class="table table-striped table-hover">
                        ...
                        <c:forEach items="${mesOeuvres}" var="item">
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-success clickable-row" data-href="reserverOeuvre.htm?id=${item.idOeuvrevente}" style="padding: 4px"><em class="fa fa-book"> Réserver</em></a>
